...
scrypt.run()
```
En conjunto, todo el scrypt [`unzip_cracker.py`](https://github.com/1ocho3/ufv_CTF/blob/85d77e756cb351dd3c3942966b786e9a3481c44d/files/unzip_cracker.py) queda de la siguiente forma:
```python
if __name__=='__main__':
    import os
    class unzip_cracker:
